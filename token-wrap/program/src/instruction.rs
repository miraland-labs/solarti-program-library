...
pub enum TokenWrapInstruction {
    ...
    /// 4. `[]` System program
    /// 5. `[]` Solarti Token program for wrapped mint
    ///
    ...
    /// 6. `[]` Solarti Token program for unwrapped mint
    /// 7. `[]` Solarti Token program for wrapped mint
    ...
    ///    `get_wrapped_mint_authority(wrapped_mint)`
    /// 6. `[]` Solarti Token program for wrapped mint
    /// 7. `[]` Solarti Token program for unwrapped mint
