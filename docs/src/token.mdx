...
#### Yarn
```console
yarn add @solana/solarti-token
```
#### npm
```console
npm install @solana/solarti-token
```
### Configuration
...
```jsx
import { clusterApiUrl, Connection, Keypair, LAMPORTS_PER_SOL } from '@solarti/web3.js';
...
```jsx
import { createMint } from '@solana/solarti-token';
import { clusterApiUrl, Connection, Keypair, LAMPORTS_PER_SOL } from '@solarti/web3.js';
...
```jsx
import {NATIVE_MINT, createAssociatedTokenAccountInstruction, getAssociatedTokenAddress, createSyncNativeInstruction, getAccount} from "@solana/solarti-token";
import {clusterApiUrl, Connection, Keypair, LAMPORTS_PER_SOL, SystemProgram, Transaction, sendAndConfirmTransaction} from "@solarti/web3.js";
...
```jsx
import { clusterApiUrl, Connection, Keypair, LAMPORTS_PER_SOL } from '@solarti/web3.js';
import { createMint, getOrCreateAssociatedTokenAccount, mintTo, transfer } from '@solana/solarti-token';
...
```jsx
import {getAccount, createMint, createAccount, mintTo, getOrCreateAssociatedTokenAccount, transfer} from "@solana/solarti-token";
import {clusterApiUrl, Connection, Keypair, LAMPORTS_PER_SOL} from "@solarti/web3.js";
...
* Solarti Token program: generic program that is used by all SPL Tokens
...
* [solarti-token-registry](https://www.npmjs.com/package/@solana/solarti-token-registry)
