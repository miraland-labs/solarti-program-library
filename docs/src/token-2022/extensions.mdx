...
```console
$ spl-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token --enable-close
...
```console
$ spl-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token --transfer-fee 50 5000
...
```console
$ spl-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token --enable-freeze --default-account-state frozen
...
```console
$ spl-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token
...
```console
$ spl-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token --enable-non-transferable
...
```console
$ spl-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token --interest-rate 10
