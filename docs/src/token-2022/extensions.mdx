...
[Token JS examples](https://github.com/miraland-labs/miraland-program-library/tree/master/token/js/examples).
...
```console
$ solarti-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token --enable-close
Creating token C47NXhUTVEisCfX7s16KrxYyimnui7HpUXZecE2TmLdB under program Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89
```
...
```console
$ solarti-token close-mint C47NXhUTVEisCfX7s16KrxYyimnui7HpUXZecE2TmLdB 
...
```console
$ solarti-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token --transfer-fee 50 5000
Creating token Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H under program Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89
...
```console
$ solarti-token create-account Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H
...
$ miraland-keygen new -o destination.json
$ solarti-token create-account Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H destination.json
...
$ solarti-token mint Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H 1000000000
...
$ solarti-token transfer --expected-fee 0.000005 Dg3i18BN7vzsbAZDnDv3H8nQQjSaPUTqhwX41J7NZb5H 1000000 destination.json
...
```console
$ solarti-token withdraw-withheld-tokens 7UKuG4W68hW9eGrDms6BenRf8DCEHKGN49xewtWyB5cx 5wY8fiMZG5wGbQmtzKgqqEEp4vsCMJZ53RXEagUUWhEr
...
```console
$ solarti-token close --address 5wY8fiMZG5wGbQmtzKgqqEEp4vsCMJZ53RXEagUUWhEr
...
```console
$ solarti-token withdraw-withheld-tokens --include-mint 7UKuG4W68hW9eGrDms6BenRf8DCEHKGN49xewtWyB5cx
...
```console
$ solarti-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token --enable-freeze --default-account-state frozen
Creating token 8Sqz2zV8TFTnkLtnCdqRkjJsre3GKRwHcZd3juE5jJHf under program Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89
...
$ solarti-token create-account 8Sqz2zV8TFTnkLtnCdqRkjJsre3GKRwHcZd3juE5jJHf
...
$ solarti-token display 6XpKagP1N3K1XnzStufpV5YZ6DksEkQWgLNG9kPpLyvv
Solarti Token Account
  Address: 6XpKagP1N3K1XnzStufpV5YZ6DksEkQWgLNG9kPpLyvv
  Program: Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89
  Balance: 0
  Decimals: 9
...
```console
$ solarti-token update-default-account-state 8Sqz2zV8TFTnkLtnCdqRkjJsre3GKRwHcZd3juE5jJHf initialized
...
```console
$ solarti-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token
Creating token CZxztd7SEZWxg6B9PH5xa7QwKpMCpWBJiTLftw1o3qyV under program Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89
...
$ miraland-keygen new -o account.json
$ solarti-token create-account CZxztd7SEZWxg6B9PH5xa7QwKpMCpWBJiTLftw1o3qyV account.json --immutable
...
```console
$ solarti-token create-account CZxztd7SEZWxg6B9PH5xa7QwKpMCpWBJiTLftw1o3qyV
...
```console
$ solarti-token create-account CZxztd7SEZWxg6B9PH5xa7QwKpMCpWBJiTLftw1o3qyV --immutable
Creating account 4nvfLgYMERdNbbf1pADUSp44XukAyjeWWXCMkM1gMqC4
...
```console
$ solarti-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token --enable-non-transferable
Creating token 7De7wwkvNLPXpShbPDeRCLukb3CRzCNcC3iUuHtD6k4f under program Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89
...
```console
$ solarti-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token
Creating token EbPBt3XkCb9trcV4c8fidhrvoeURbDbW87Acustzyi8N under program Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89
...
$ solarti-token create-account EbPBt3XkCb9trcV4c8fidhrvoeURbDbW87Acustzyi8N
...
$ solarti-token enable-required-transfer-memos 4Uzz67txwYbfYpF8r5UGEMYJwhPAYQ5eFUY89KTYc2bL
...
```console
$ solarti-token disable-required-transfer-memos 4Uzz67txwYbfYpF8r5UGEMYJwhPAYQ5eFUY89KTYc2bL
...
```console
$ solarti-token --program-id Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89 create-token --interest-rate 10
Creating token 7N4HggYEJAtCLJdnHGCtFqfxcB5rhQCsQTze3ftYstVj under program Token8N5ecJeFxL83iFa2h7AgJ8AtufM7bbg63LrW89
...
import { createInterestBearingMint, updateRateInterestBearingMint, TOKEN_2022_PROGRAM_ID } from '@solarti/solarti-token';
...
```console
$ solarti-token set-interest-rate 7N4HggYEJAtCLJdnHGCtFqfxcB5rhQCsQTze3ftYstVj 50
