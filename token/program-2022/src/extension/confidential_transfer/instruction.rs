...
pub enum ConfidentialTransferInstruction {
    ...
    ///   0. `[writeable]` TheSolarti Token account.
    ...
    ///   4.. `[signer]` Required M signer accounts for the Solarti Token Multisig
    /// account.
    ///
    /// Data expected by this instruction:
    ...
    /// Solarti Token mint.  This instruction must be executed after the account
    ...
    ///   3.. `[signer]` Required M signer accounts for the Solarti Token Multisig
    /// account.
    ///
    /// Data expected by this instruction:
    ...
    ///   2. `[]` The token mint.
    ///   3. `[writable]` The destination Solarti Token account.
    ...
    ///   6.. `[signer]` Required M signer accounts for the Solarti Token Multisig
    /// account.
    ///
    /// Data expected by this instruction:
...
pub struct TransferWithSplitProofsInstructionData {
    ...
    ///
    /// NOTE: This field is to be removed in the next Miraland upgrade.
