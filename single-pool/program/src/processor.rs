...
/// We floor at 1mln to avoid over-minting tokens before the relevant feature is
/// active
...
mod tests {
    ...
    fn random_deposit_withdraw(seed: u64, with_rewards: bool, no_minimum: bool) {
        ...
        let deposit_range = Uniform::from(LAMPORTS_PER_MLN..LAMPORTS_PER_MLN * 1000);
        let minnow_range = Uniform::from(1..LAMPORTS_PER_MLN);
