...
async fn test_success() {
    ...
    const MLN_DEPOSIT_AMOUNT: u64 = 100;
    const USDC_BORROW_AMOUNT: u64 = 1_000;
    const MLN_DEPOSIT_AMOUNT_LAMPORTS: u64 =
        MLN_DEPOSIT_AMOUNT * LAMPORTS_TO_MLN * INITIAL_COLLATERAL_RATIO;
    ...
    let collateral_price = collateral.market_value.try_div(MLN_DEPOSIT_AMOUNT).unwrap();
    ...
    assert_eq!(mln_reserve.liquidity.market_price, collateral_price,);
